<header class="sticky top-0 z-40 w-full flex items-center justify-between px-6 h-14 bg-surface-container-lowest border-b border-outline-variant shadow-sm transition-colors duration-300">
    ...
    <div class="flex items-center gap-4">
        ...
        <div class="flex items-center gap-3 cursor-pointer group">
            <span class="text-sm font-bold text-on-surface group-hover:text-primary transition-colors">Alex Rivers</span>
            <img alt="User profile photo" class="w-9 h-9 rounded-full border-2 border-outline-variant group-hover:border-primary transition-all object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDh-euMwu-jP_Tu9tp8CktGP19S8W5HqWxc27MZuscAGiIZGbbFkZwjrU9bDJ3gAhxtq5sn7I1NbfbWqWhesHF6QzzSuxhRQweLpTcP2PqTXk917rnahzqxjumYmylomw-mp_T0h4a-zQCRSJotHjIwrdQz2hdaCqC6uo1ScBqj6yDYTrvTIAf6oJhPx10KIIyG5v-fcrutJiqeyNHpwPYcH3hrvzgrcZm90K-ynRJyuiTlqL8kIy3ce7Q_jaWY0sA9odLqacT3rV7Q"/>
        </div>
    </div>
</header>
